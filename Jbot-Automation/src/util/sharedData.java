...
public class sharedData {
	...
	public static  int maximPageLoadWaitTime = 3000;
	...
	public static final String mailSendersAddress = "yourEmail@gmail.com";
	public static final String mailSendersPassword = "Y0urMailPassw0rd!";
	...
	//public static String latestDownloadedFile = "C:\\Users\\Phalguni\\Downloads\\Study_Site_Test_-09262017 (3).csv";;
	public static String latestDownloadedFile =  util.general.ExcelUtility.getValue(sharedData.envConfigurationSheetInstance,
			"File to upload", sharedData.autPosition);
